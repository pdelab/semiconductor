...
int main()
{
    ...
    char filenm[] = "./params/protein-exp-names.dat";
    ...
    printf("    Extracellular Voltage:                %15.10f mV\n", ext_voltage); fflush(stdout);
    printf("    Intracellular Voltage:                %15.10f mV\n", int_voltage); fflush(stdout);
    printf("    Extracellular Sodium Bulk Density:    %15.10f M\n", ext_na_bulk); fflush(stdout);
    printf("    Intracellular Sodium Bulk Density:    %15.10f M\n", int_na_bulk); fflush(stdout);
    printf("    Extracellular Potassium Bulk Density: %15.10f M\n", ext_k_bulk);  fflush(stdout);
    printf("    Intracellular Potassium Bulk Density: %15.10f M\n", int_k_bulk);  fflush(stdout);
    printf("    Extracellular Chloride Bulk Density:  %15.10f M\n", ext_cl_bulk); fflush(stdout);
    printf("    Intracellular Chloride Bulk Density:  %15.10f M\n", int_cl_bulk); fflush(stdout);
    printf("    Extracellular Calcium Bulk Density:   %15.10f M\n", ext_ca_bulk); fflush(stdout);
    printf("    Intracellular Calcium Bulk Density:   %15.10f M\n", int_ca_bulk); fflush(stdout);
